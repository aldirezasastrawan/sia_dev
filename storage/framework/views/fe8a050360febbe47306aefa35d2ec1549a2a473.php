...
<br>
	<div class="container">	
		<h1>
            Nilai Non Akademik Siswa Kelas 2
            <small>Control panel</small>
	    </h1>
		      <ol class="breadcrumb">
		        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
		        <li class="active">Data Nilai Non Akademik Siswa <?php echo e(Auth::user()->role->namaRule); ?></li>
		      </ol>
				    <meta charset="utf-8">
	                	...
	                	<div class="box-body">
	                		<h3 class="box-title">Nilai Non Akademik </h3>
		                        ...
		                        <div id="panel_tab2_example1" class="tab-pane active">
		                            <form action="<?php echo e(URL:: to('/nilainonakademik/tambah/simpannilainonakademikkelas')); ?>" method="post">
