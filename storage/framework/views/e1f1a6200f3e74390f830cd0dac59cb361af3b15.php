        ...
        <body>
            ...
            <table class="tg">
              ...
              <tr>
                ...
                <td class="tg-rv4w" width="20%"><?php echo e(date('d M Y' ,strtotime($data->tanggal))); ?></td>
                <td class="tg-rv4w" width="50%"><?php echo e($data->siswa->nama_siswa); ?></td>
                <td class="tg-rv4w" width="40%"><?php echo e($data->thn_ajaran); ?></td>
