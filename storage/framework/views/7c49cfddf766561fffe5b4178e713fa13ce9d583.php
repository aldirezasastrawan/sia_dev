  ...
  <div class="container"> 
    <h1>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Nilai Akademik Siswa <?php echo e(Auth::user()->role->namaRule); ?></li>
          </ol>
            <meta charset="utf-8">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="jumbotron">
                        <h3>Pilih Kelas</h3>
                        <br>
                            <a href="<?php echo e(url('/nilaiakademikadmin/tambah/kelas1')); ?>" class="btn btn-default"><i class="fa fa-hand-o-right"></i>  Kelas 1</a>
