    ...
    <head>
        ...
        <body>
            ...
            <table class="tg">
              ...
              <?php $i++ ?>
              <tr>
                <td class="tg-rv4w" width="10%"><?php echo e($i); ?></td>
                <td class="tg-rv4w" width="20%"><?php echo e($data->nis); ?></td>
                <td class="tg-rv4w" width="40%"><?php echo e($data->nik); ?></td>
                <td class="tg-rv4w" width="30%"><?php echo e($data->nama_siswa); ?></td>
                <td class="tg-rv4w" width="30%"><?php echo e($data->jenis_kelamin); ?></td>
                <td class="tg-rv4w" width="30%"><?php echo e($data->tempat_lahir); ?></td>
                <td class="tg-rv4w" width="30%"><?php echo e(date('d M Y' ,strtotime($data->tanggal_lahir))); ?></td>
                <td class="tg-rv4w" width="30%"><?php echo e($data->alamat); ?></td>
                <td class="tg-rv4w" width="30%"><?php echo e($data->tlp); ?></td>
