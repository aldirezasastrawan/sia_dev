                     ...
                     <?php foreach($kelass as $data): ?>
                      <tr>			
						...
						<td><a href="<?php echo e(URL::to('kelas/'.$data->id.'/ubah')); ?>">
	                        ...
	                        <a href="<?php echo e(URL::to('kelas/hapus',[$data->id])); ?>" title="hapus"   onclick="return confirm('Apakah anda yakin akan menghapus Kelas <?php echo e(($data->id).' - '.$data->nama_kelas); ?>?')">
	                            <span class="label label-danger"><i class="fa fa-trash"> Delete </i></span></a>             
	                      	<a href="<?php echo e(URL::to('kelas/'.$data->id.'/detail')); ?>">
