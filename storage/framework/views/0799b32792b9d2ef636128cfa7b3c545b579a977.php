...
<br>
		...
		<h1>
            ...
            <small>Control panel</small>
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="active">Data Nilai Akademik <?php echo e(Auth::user()->role->namaRule); ?></li>
		      </ol>
				    <meta charset="utf-8">
    ...
    <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-body">
                	<h3 class="box-title">Daftar Data Nilai Akademik <a href="<?php echo e(URL::to('/nilaiakademikadmin/tambah')); ?>" class="btn btn-success btn-flat btn-sm" data-toggle="modal" title="Tambah"><i class="fa fa-plus"></i></a></h3>
				</div>
				<div class=row>
		            <div class="col-md-6">
		                <a href="<?php echo e(url('/nilaiakademikadmin')); ?>" class="btn btn-success"><i class="fa fa-refresh"></i> Semua Data</a>
		                <a href="<?php echo e(URL::to('/nilaiakademikadmin/pdf')); ?>" class="btn btn-danger"><i class="fa fa-print"></i> Cetak Data</a>
		            </div>
		            <div class="col-md-2">
		            </div>
		            <!-- Form Pencarian -->
		            <div class="col-md-4">
		                <?php echo Form::open(['method'=>'GET','url'=>'carinilaiakademikadmin']); ?>
                  ...
                  <table id="dataGuru" class="table table-bordered table-hover">
                    ...
                    <tbody>
                     <?php foreach($nilaiakademiks as $data): ?>
                      <tr>			
						...
						<td><a href="<?php echo e(URL::to('nilaiakademikadmin/'.$data->id.'/ubah')); ?>">
	                         	<span class="label label-warning"><i class="fa fa-edit"> Edit </i></span></a>
	                        <a href="<?php echo e(URL::to('nilaiakademikadmin/hapus',[$data->id])); ?>" title="hapus"   onclick="return confirm('Apakah anda yakin akan menghapus Data Nilai Akademik <?php echo e(($data->pelajaran->nama_pelajaran).' - '.$data->siswa->nama_siswa); ?>?')">
