...
<br>
	<div class="container">	
		<h1>
            ...
            <small>Control panel</small>
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="active">Data Kelas <?php echo e(Auth::user()->role->namaRule); ?></li>
		      </ol>
				    <meta charset="utf-8">
  	...
  	<?php if(Session::has('message')): ?>
  		<div class="alert-alert"><?php echo e(Session::get('message')); ?></div>
  	<?php endif; ?>	
    <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-body">
                	<h3 class="box-title">Daftar Kelas <a href="<?php echo e(URL::to('/kelas/tambah')); ?>" class="btn btn-success btn-flat btn-sm" data-toggle="modal" title="Tambah"><i class="fa fa-plus"></i></a></h3>
				</div>
				<div class=row>
		            <div class="col-md-6">
		                <a href="<?php echo e(url('/kelas')); ?>" class="btn btn-success"><i class="fa fa-refresh"></i> Semua Data</a>
		            </div>
		            <div class="col-md-2">
		            </div>
		            <!-- Form Pencarian -->
		            <div class="col-md-4">
		                <?php echo Form::open(['method'=>'GET','url'=>'carikelas']); ?>
                  ...
                  <table id="dataSiswa" class="table table-bordered table-hover">
                    ...
                    <tbody>
                     <?php foreach($kelass as $data): ?>
                      <tr>			
						<td><?php echo e($data->id); ?></td>
						<td><?php echo e($data->nama_kelas); ?></td>
						<td><a href="<?php echo e(URL::to('kelas/'.$data->id.'/ubah')); ?>">
	                         	<span class="label label-warning"><i class="fa fa-edit"> Edit </i></span></a>
	                        <a href="<?php echo e(URL::to('kelas/hapus',[$data->id])); ?>" title="hapus"   onclick="return confirm('Apakah anda yakin akan menghapus ID kelas ke <?php echo e(($data->id).' - '.$data->nama_kelas); ?>?')">
