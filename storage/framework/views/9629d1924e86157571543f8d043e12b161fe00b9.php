		...
		<h1>
            ...
            <small>Control panel</small>
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="active">Tambah Data Pelajaran <?php echo e(Auth::user()->role->namaRule); ?></li>
		      </ol>
				    <meta charset="utf-8">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body no-padding">
                      <div class="box-body no-padding">
                      <?php echo e(Form::open(array('url' => '/pelajaran/simpantambah', 'class' => 'form-horizontal', 'id' => 'formPelajaranTambah'))); ?>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  <?php if($errors->has('nama_pelajaran')): ?> has-error <?php endif; ?>">
                              <input type="text" class="form-control" name="nama_pelajaran" value="<?php echo e(Request::old('nama_pelajaran')); ?>" placeholder="Masukkan Nama Pelajaran" maxlength="100" required autofocus>
                      ...
                      <div class="form-group">
                          <label class="col-md-3 control-label">Durasi Waktu <span class="required">* </span></label>
                            <div class="col-md-3  <?php if($errors->has('durasi')): ?> has-error <?php endif; ?>">
                              <select name="durasi" class="form-control" value="<?php echo e(Request::old('durasi')); ?>" required>
