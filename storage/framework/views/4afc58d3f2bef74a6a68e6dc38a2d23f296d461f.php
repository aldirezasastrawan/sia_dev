<html>
    <head>
        ...
        <title>Jadwal Pelajaran Siswa Sirojul Munir Bekasi</title>
        <body>
            <style type="text/css">
            ...
            <div style="font-family:Arial; font-size:12px;">
                <center>
                    <font size="14">JADWAL PELAJARAN SISWA<br>
              ...
              <?php endforeach; ?>
                ...
                <table border="0" >                    
                      <tr>
                        ...
                        <td align="center">NB : Diharapkan Seluruh Siswa Tepat Waktu Sesuai Jadwal dan Ruangan yang Sudah ditentukan.</td>
                      </tr>
                </table>
        </body>
    </head>
