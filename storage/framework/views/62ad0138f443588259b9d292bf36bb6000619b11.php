		...
		<h1>
            ...
            <small>Control panel</small>
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="active">Ubah Data Nilai Non Akademik <?php echo e(Auth::user()->role->namaRule); ?></li>
		      </ol>
				    <meta charset="utf-8">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body no-padding">
                      <div class="box-body no-padding">
                      <?php echo e(Form::model($nilainonakademiks, array('url' => array('nilainonakademikadmin/simpanubah', $nilainonakademiks->id),'class' => 'form-horizontal', 'id' => 'formNilainonakademikUbah', ))); ?>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  <?php if($errors->has('nama_siswa')): ?> has-error <?php endif; ?>">
                              <input type="text" class="form-control" name="nama_siswa" value="<?php echo e($nilainonakademiks->siswa->nama_siswa); ?>" disabled="">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  <?php if($errors->has('nama_pelajaran')): ?> has-error <?php endif; ?>">
                              <input type="text" class="form-control" name="nama_pelajaran" value="<?php echo e($nilainonakademiks->Pelajaran->nama_pelajaran); ?>" disabled="">
                              <small class="help-block"></small>
                              <!-- <?php if($errors->has('jurNama')): ?> <small class="help-block"><?php echo e($errors->first('jurNama')); ?></small> <?php endif; ?> -->
                          </div>
                      </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-3  <?php if($errors->has('nilai_tugas')): ?> has-error <?php endif; ?>">
                              <input type="text" class="form-control" name="nilai_tugas" value="<?php echo e($nilainonakademiks->nilai_tugas); ?>">
                              <small class="help-block"></small>
                              <!-- <?php if($errors->has('jurNama')): ?> <small class="help-block"><?php echo e($errors->first('jurNama')); ?></small> <?php endif; ?> -->
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  <?php if($errors->has('nilai_ulangan')): ?> has-error <?php endif; ?>">
                              <input type="text" class="form-control" name="nilai_ulangan" value="<?php echo e($nilainonakademiks->nilai_ulangan); ?>">
                              <small class="help-block"></small>
                              <!-- <?php if($errors->has('jurNama')): ?> <small class="help-block"><?php echo e($errors->first('jurNama')); ?></small> <?php endif; ?> -->
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  <?php if($errors->has('jumlah_nilai')): ?> has-error <?php endif; ?>">
                              <input type="text" class="form-control" name="jumlah_nilai" value="<?php echo e($nilainonakademiks->jumlah_nilai); ?>">
                              <small class="help-block"></small>
                              <!-- <?php if($errors->has('jurNama')): ?> <small class="help-block"><?php echo e($errors->first('jurNama')); ?></small> <?php endif; ?> -->
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          <div class="col-md-6 col-md-offset-4">
                              ...
                              <a href="<?php echo e(URL::to('nilainonakademikadmin')); ?>" title="Cancel">
