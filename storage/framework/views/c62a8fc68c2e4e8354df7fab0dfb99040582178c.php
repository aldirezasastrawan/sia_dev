		...
		<h1>
            ...
            <small>Control panel</small>
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="active">Ubah Data Pengguna <?php echo e(Auth::user()->role->namaRule); ?></li>
		      </ol>
				    <meta charset="utf-8">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body no-padding">
                      <div class="box-body no-padding">
                      <?php echo e(Form::model($users, array('url' => array('register/simpanubah', $users->id),'class' => 'form-horizontal', 'id' => 'formJadwalUbah', ))); ?>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  <?php if($errors->has('name')): ?> has-error <?php endif; ?>">
                              <input type="text" class="form-control" name="name" value="<?php echo e($users->name); ?>" required="">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  <?php if($errors->has('password')): ?> has-error <?php endif; ?>">
