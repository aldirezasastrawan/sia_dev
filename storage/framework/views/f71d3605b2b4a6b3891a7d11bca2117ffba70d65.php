              ...
              <div class="box">
                <div class="box box-primary">   
                  ...
                  <div class="box-body no-padding">
                      <form id="formResetPassword" class="form-horizontal" role="form" method="POST" action="<?php echo e(URL::to('/ubahpassword')); ?>">
                      ...
                      <div class="form-group">
                          <div class="col-md-6 col-md-offset-4">
                              ...
                              <a href="<?php echo e(URL::to('/pimpinan')); ?>" title="Cancel">
