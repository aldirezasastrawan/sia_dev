  ...
  <div class="container"> 
    <h1>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Data Pengguna Siswa <?php echo e(Auth::user()->role->namaRule); ?></li>
          </ol>
            <meta charset="utf-8">
    ...
    <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-body">
                  <h3 class="box-title">Data Pengguna Siswa </h3>
                </div>
              <div class=row>
                      <div class="col-md-6">
                          <a href="<?php echo e(url('/siswa')); ?>" class="btn btn-success"><i class="fa fa-refresh"></i> Semua Data</a>
                      </div>
                      <div class="col-md-2">
                      </div>
                      <!-- Form Pencarian -->
                      <div class="col-md-4">
                          <?php echo Form::open(['method'=>'GET','url'=>'carisiswa']); ?>
                    ...
                    <tbody>
                     <?php foreach($siswas as $data): ?>
                      <tr>      
                        ...
                        <td><a href="<?php echo e(URL::to('register/'.$data->nama_siswa.'/aktif')); ?>" class="btn btn-success btn-flat btn-sm" title="Register"><i class="fa fa-plus"></i></a>
                        </td>
                      </tr>
                      <?php endforeach; ?> 
                    </tbody>
