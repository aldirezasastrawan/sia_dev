  ...
  <div class="container"> 
    <h1>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Tambah Data Pembayaran Siswa <?php echo e(Auth::user()->role->namaRule); ?></li>
          </ol>
            <meta charset="utf-8">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="jumbotron">
                        <h3>Pilih Kelas</h3>
                        <br>
                            <a href="<?php echo e(url('/pembayaranadmin/tambah/kelas1')); ?>" class="btn btn-default"><i class="fa fa-hand-o-right"></i>  Kelas 1</a>
                            &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                            <a href="<?php echo e(URL::to('/nilaiakademikadmin/tambah/kelas2')); ?>" class="btn btn-primary"><i class="fa fa-hand-o-right"></i>  Kelas 2</a>
                            &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                            <a href="<?php echo e(url('/nilaiakademikadmin/tambah/kelas3')); ?>" class="btn btn-success"><i class="fa fa-hand-o-right"></i>  Kelas 3</a>
                            &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                            <a href="<?php echo e(URL::to('/nilaiakademikadmin/tambah/kelas4')); ?>" class="btn btn-info"><i class="fa fa-hand-o-right"></i>  Kelas 4</a>
                            &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                            <a href="<?php echo e(url('/nilaiakademikadmin/tambah/kelas5')); ?>" class="btn btn-warning"><i class="fa fa-hand-o-right"></i>  Kelas 5</a>
                            &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                            <a href="<?php echo e(URL::to('/nilaiakademikadmin/tambah/kelas6')); ?>" class="btn btn-danger"><i class="fa fa-hand-o-right"></i>  Kelas 6</a>
                    </div><!-- /.box -->
                </div>
            </div><!-- /.row (main row) -->
  </div>
