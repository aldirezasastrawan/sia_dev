		...
		<h1>
            ...
            <small>Control panel</small>
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="active">Ubah Data Pelajaran <?php echo e(Auth::user()->role->namaRule); ?></li>
		      </ol>
				    <meta charset="utf-8">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body no-padding">
                      <div class="box-body no-padding">
                      <?php echo e(Form::model($pelajarans, array('url' => array('pelajaran/simpanubah', $pelajarans->id),'class' => 'form-horizontal', 'id' => 'formPelajaranUbah', ))); ?>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  <?php if($errors->has('nama_pelajaran')): ?> has-error <?php endif; ?>">
                              <input type="text" class="form-control" name="nama_pelajaran" value="<?php echo e($pelajarans->nama_pelajaran); ?>">
                      ...
                      <div class="form-group">
                          <label class="col-md-3 control-label">Durasi Waktu <span class="required">* </span></label>
                            <div class="col-md-3  <?php if($errors->has('durasi')): ?> has-error <?php endif; ?>">
                              
                                      <?php echo e(Form::select('durasi', array('' => ' ----- Pilih Durasi Pelajaran ----- ',
                               '45 Menit' => '45 Menit',
                               '60 Menit' => '60 Menit',
                               ), $pelajarans->durasi, array('class' => 'form-control'))); ?>
                      ...
                      <div class="form-group">
                          <label class="col-md-3 control-label">Keterangan <span class="required">* </span></label>
		                        <div class="col-md-3  <?php if($errors->has('keterangan')): ?> has-error <?php endif; ?>">
		                                  ...
		                                  <?php echo e(Form::select('keterangan', array('' => ' ----- Pilih Jenis Pelajaran ----- ',
														   'Pelajaran Akademik' => 'Pelajaran Akademik',
														   'Pelajaran Non Akademik' => 'Pelajaran Non Akademik',
														   ), $pelajarans->keterangan, array('class' => 'form-control'))); ?>
                      ...
                      <div class="form-group">
                          <div class="col-md-6 col-md-offset-4">
                              ...
                              <a href="<?php echo e(URL::to('pelajaran')); ?>" title="Cancel">
