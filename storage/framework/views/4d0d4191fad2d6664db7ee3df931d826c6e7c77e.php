                  ...
                  <div class="box-body no-padding">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  <?php if($errors->has('nis')): ?> has-error <?php endif; ?>">
                              <input type="text" class="form-control" name="nis" value="<?php echo e(Request::old('nis')); ?>">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  <?php if($errors->has('nik')): ?> has-error <?php endif; ?>">
                              <input type="text" class="form-control" name="nik" value="<?php echo e(Request::old('nik')); ?>" placeholder="Masukkan NIK Siswa">
                              <small class="help-block"></small>
                              <!-- <?php if($errors->has('jurNama')): ?> <small class="help-block"><?php echo e($errors->first('jurNama')); ?></small> <?php endif; ?> -->
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-4  <?php if($errors->has('nama_siswa')): ?> has-error <?php endif; ?>">
                              <input type="text" class="form-control" name="nama_siswa" value="<?php echo e(Request::old('nama_siswa')); ?>" placeholder="Masukkan Nama Siswa" >
                              <small class="help-block"></small>
                              <!-- <?php if($errors->has('jurNama')): ?> <small class="help-block"><?php echo e($errors->first('jurNama')); ?></small> <?php endif; ?> -->
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          <label class="col-md-3 control-label">Jenis Kelamin <span class="required">* </span></label>
		                        <div class="col-md-3  <?php if($errors->has('jenis_kelamin')): ?> has-error <?php endif; ?>">
	                      			<select name="jenis_kelamin" class="form-control" value="<?php echo e(Request::old('jenis_kelamin')); ?>" >
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-4  <?php if($errors->has('tempat_lahir')): ?> has-error <?php endif; ?>">
                              <input type="text" class="form-control" name="tempat_lahir" value="<?php echo e(Request::old('tempat_lahir')); ?>" placeholder="Masukkan Tempat Lahir" >
                              <small class="help-block"></small>
                              <!-- <?php if($errors->has('jurNama')): ?> <small class="help-block"><?php echo e($errors->first('jurNama')); ?></small> <?php endif; ?> -->
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  <?php if($errors->has('tanggal_lahir')): ?> has-error <?php endif; ?>">
                              <input type="date" class="form-control" name="tanggal_lahir" value="<?php echo e(Request::old('tanggal_lahir')); ?>" >
                              <small class="help-block"></small>
                              <!-- <?php if($errors->has('jurNama')): ?> <small class="help-block"><?php echo e($errors->first('jurNama')); ?></small> <?php endif; ?> -->
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-6  <?php if($errors->has('alamat')): ?> has-error <?php endif; ?>">
                              <textarea type="text" class="form-control" name="alamat" rows="4" value="<?php echo e(Request::old('alamat')); ?>" placeholder="Masukkan Alamat" ></textarea>
                              <small class="help-block"></small>
                              <!-- <?php if($errors->has('jurNama')): ?> <small class="help-block"><?php echo e($errors->first('jurNama')); ?></small> <?php endif; ?> -->
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  <?php if($errors->has('tlp')): ?> has-error <?php endif; ?>">
                              <input type="text" class="form-control" name="tlp" value="<?php echo e(Request::old('tlp')); ?>" placeholder="Masukkan No Telphone" >
                              <small class="help-block"></small>
                              <!-- <?php if($errors->has('jurNama')): ?> <small class="help-block"><?php echo e($errors->first('jurNama')); ?></small> <?php endif; ?> -->
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          <label class="col-md-3 control-label">Tahun Ajaran <span class="required">* </span></label>
                          		<div class="col-md-3  <?php if($errors->has('tahun_ajaran')): ?> has-error <?php endif; ?>">
                          			<select name="tahun_ajaran" id="value" class="form-control" value="<?php echo e(Request::old('tahun_ajaran')); ?>" >
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  <?php if($errors->has('nama_wali')): ?> has-error <?php endif; ?>">
                              <input type="text" class="form-control" name="nama_wali" value="<?php echo e(Request::old('nama_wali')); ?>" placeholder="Masukkan Nama Wali Siswa">
                              <small class="help-block"></small>
                              <!-- <?php if($errors->has('jurNama')): ?> <small class="help-block"><?php echo e($errors->first('jurNama')); ?></small> <?php endif; ?> -->
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          <label class="col-md-3 control-label">Keterangan <span class="required">* </span></label>
                          	<div class="col-md-3  <?php if($errors->has('keterangan')): ?> has-error <?php endif; ?>">
                              		<select name="keterangan" id="value" class="form-control" value="<?php echo e(Request::old('tahun_ajaran')); ?>" >
