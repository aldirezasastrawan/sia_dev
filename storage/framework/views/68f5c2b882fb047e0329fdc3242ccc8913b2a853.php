        ...
        <body>
            ...
            <table class="tg">
              ...
              <tr>
                ...
                <td class="tg-rv4w" width="20%" align="center" ><?php echo e($data->kelas); ?></td>
                <td class="tg-rv4w" width="50%"><?php echo e(date('l, d F Y' ,strtotime($data->tanggal))); ?></td>
                <td class="tg-rv4w" width="30%"><?php echo e($data->siswa->nama_siswa); ?></td>
                <td class="tg-rv4w" width="20%"><?php echo e($data->thn_ajaran); ?></td>
