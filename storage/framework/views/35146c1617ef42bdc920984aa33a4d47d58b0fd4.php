		...
		<h1>
            ...
            <small>Control panel</small>
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="active">Data Rapor <?php echo e(Auth::user()->role->namaRule); ?></li>
		      </ol>
				    <meta charset="utf-8">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
                  ...
                  <li class="list-group-item">
                      <b>Tempat Lahir</b> <a class="pull-right"><?php echo e($siswas->tempat_lahir); ?></a>
                  </li>
                  <li class="list-group-item">
                      <b>Tanggal Lahir</b> <a class="pull-right"><?php echo e($siswas->tanggal_lahir); ?></a>
                  </li>
                  <li class="list-group-item">
                      <b>Telfon</b> <a class="pull-right"><?php echo e($siswas->tlp); ?></a>
                  </li>
                  <li class="list-group-item">
                      <b>Alamat</b> <a class="pull-right"><?php echo e($siswas->alamat); ?></a>
                  </li>
                  <li class="list-group-item">
                      <b>Tahun AJaran</b> <a class="pull-right"><?php echo e($siswas->tahun_ajaran); ?></a>
                  </li>
              </ul>
            </div>
            <!-- /.box-body -->
