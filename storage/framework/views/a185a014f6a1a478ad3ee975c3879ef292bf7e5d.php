...
<br>
		...
		<h1>
            ...
            <small>Control panel</small>
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="active">Data Rapor Siswa <?php echo e(Auth::user()->role->namaRule); ?></li>
		      </ol>
				    <meta charset="utf-8">
    ...
    <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-body">
                	<h3 class="box-title">Daftar Rapor Siswa </h3>
				</div>
				<div class=row>
		            <div class="col-md-6">
		                <a href="<?php echo e(url('/raporadmin')); ?>" class="btn btn-success"><i class="fa fa-refresh"></i> Semua Data</a>
		            </div>
		            <div class="col-md-2">
		            </div>
		            <!-- Form Pencarian -->
		            <div class="col-md-4">
		                <?php echo Form::open(['method'=>'GET','url'=>'cariraporsiswa']); ?>
                    ...
                    <tbody>
                     <?php foreach($siswas as $data): ?>
                      <tr>			
                        ...
                        <td><a href="<?php echo e(URL::to('raporadmin/'.$data->nama_siswa.'/detail')); ?>">
                              <span class="label label-danger"><i class="fa fa-envelope"> Rapor Akademik </i></span>
                              </a>
                              <br>
                              <br>
                        	<a href="<?php echo e(URL::to('raporadmin/'.$data->nama_siswa.'/rapor')); ?>">
                              <span class="label label-info"><i class="fa fa-envelope"> Rapor Non Akademik </i></span>
                              </a>
                        </td>
                      </tr>
                      <?php endforeach; ?> 
