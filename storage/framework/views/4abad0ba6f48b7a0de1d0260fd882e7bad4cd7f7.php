            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body no-padding">
                      <div class="box-body no-padding">
                      <?php echo e(Form::open(array('url' => '/register/simpantambah', 'class' => 'form-horizontal'))); ?>
                      ...
                      <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">         
                              <div class="form-group">
                                  ...
                                  <div class="col-md-3  <?php if($errors->has('username')): ?> has-error <?php endif; ?>">
                                      <input type="text" class="form-control" name="username" value="<?php echo e(Request::old('username')); ?>" placeholder="Masukkan Username" maxlength="25" required autofocus>
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-md-3  <?php if($errors->has('name')): ?> has-error <?php endif; ?>">
                                      <input type="text" class="form-control" name="name" value="<?php echo e(Request::old('name')); ?>" placeholder="Masukkan Nama" maxlength="25" required autofocus>
                                      <small class="help-block"></small>
                                      <!-- <?php if($errors->has('jurNama')): ?> <small class="help-block"><?php echo e($errors->first('jurNama')); ?></small> <?php endif; ?> -->
                                  </div>
                              </div>   
                              ...
                              <div class="form-group">
                                  <label class="control-label col-md-4">Nama Guru </label>
                                    <div class="col-md-3">
                                      <?php echo e(Form::select('gurus_id', $gurus, null, array('class' => 'form-control input-large select2me'))); ?>
                              ...
                              <div class="form-group">
                                  <label class="control-label col-md-4">Role Level </label>
                                    <div class="col-md-3">
                                      <?php echo e(Form::select('roles_id', $roles, null, array('class' => 'form-control input-large select2me'))); ?>
