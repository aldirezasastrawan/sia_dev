            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body no-padding">
                      <div class="box-body no-padding">
                      <?php echo e(Form::open(array('url' => '/register/simpantambahguru', 'class' => 'form-horizontal'))); ?>

                      <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                       <?php echo e(Form::hidden('roles', '3', array('id' => 'roles_id'))); ?>    
...
<script>
  $(function () {
    ...
    $("select[name='gurus_id']").on('change', function() {
      // var url_target = 'pembayaranadmin/'+$(this).val() + '/ambil_tahun_ajax';
      $.ajax({
        url: "<?php echo e(URL::to('register/guru/ambil_nip_ajax')); ?>",
        data: "gurus_id="+$(this).val(),
        type: "GET"
      }).done(function(response) {
        var res = JSON.parse(response);
        $("input[name='username']").val(res.nip);
        // console.log(res);
      }).fail(function(error) {
