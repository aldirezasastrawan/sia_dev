              ...
              <div class="box">
				...
				<div class=row>
		            <div class="col-md-6">
		                ...
		                <a href="<?php echo e(URL::to('/siswa/pdf')); ?>" class="btn btn-danger"><i class="fa fa-print"></i> Cetak Data</a>
		            </div>
		            <div class="col-md-2">
		            </div>
		            <!-- Form Pencarian -->
                    ...
                    <tbody>
                     <?php foreach($siswas as $data): ?>
                      <tr>			
                        ...
                        <td><a href="<?php echo e(URL::to('siswa/'.$data->id.'/ubah')); ?>">
                        	...
                        	<a href="<?php echo e(URL::to('siswa/'.$data->nama_siswa.'/profile')); ?>">
