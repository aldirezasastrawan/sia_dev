...
<br>
	<div class="container">	
		<h1>
            Ubah Data Nilai Akademik
            <small>Control panel</small>
	    </h1>
		      <ol class="breadcrumb">
		        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
		        <li class="active">Ubah Data Nilai Akademik <?php echo e(Auth::user()->role->namaRule); ?></li>
		      </ol>
				    <meta charset="utf-8">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body no-padding">
                      <div class="box-body no-padding">
                      <?php echo e(Form::model($nilaiakademiks, array('url' => array('nilaiakademikadmin/simpanubah', $nilaiakademiks->id),'class' => 'form-horizontal', 'id' => 'formNilaiakademikUbah', ))); ?>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  <?php if($errors->has('nama_siswa')): ?> has-error <?php endif; ?>">
                              <input type="text" class="form-control" name="nama_siswa" value="<?php echo e($nilaiakademiks->siswa->nama_siswa); ?>" disabled="">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-3  <?php if($errors->has('nilai_tugas')): ?> has-error <?php endif; ?>">
                              <input type="text" class="form-control" name="nilai_tugas" value="<?php echo e($nilaiakademiks->nilai_tugas); ?>">
                              <small class="help-block"></small>
                              <!-- <?php if($errors->has('jurNama')): ?> <small class="help-block"><?php echo e($errors->first('jurNama')); ?></small> <?php endif; ?> -->
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  <?php if($errors->has('nilai_ulangan')): ?> has-error <?php endif; ?>">
                              <input type="text" class="form-control" name="nilai_ulangan" value="<?php echo e($nilaiakademiks->nilai_ulangan); ?>">
                              <small class="help-block"></small>
                              <!-- <?php if($errors->has('jurNama')): ?> <small class="help-block"><?php echo e($errors->first('jurNama')); ?></small> <?php endif; ?> -->
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          <div class="col-md-6 col-md-offset-4">
                              ...
                              <a href="<?php echo e(URL::to('nilaiakademikadmin')); ?>" title="Cancel">
