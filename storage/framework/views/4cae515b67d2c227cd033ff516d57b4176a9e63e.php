...
<br>
    ...
    <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-body">
                	<h3 class="box-title">Daftar Guru <a href="<?php echo e(URL::to('/guruadmin/tambah')); ?>" class="btn btn-success btn-flat btn-sm" data-toggle="modal" title="Tambah"><i class="fa fa-plus"></i></a></h3>
				</div>
				<div class=row>
		            <div class="col-md-6">
		                <a href="<?php echo e(url('/guruadmin')); ?>" class="btn btn-success"><i class="fa fa-refresh"></i> Semua Data</a>
		                <a href="<?php echo e(URL::to('/guruadmin/pdf')); ?>" class="btn btn-danger"><i class="fa fa-print"></i> Cetak Data</a>
		            </div>
		            <div class="col-md-2">
		            </div>
		            <!-- Form Pencarian -->
                    ...
                    <tbody>
                     <?php foreach($gurus as $data): ?>
                      <tr>			
						...
						<td><a href="<?php echo e(URL::to('guruadmin/'.$data->id.'/ubah')); ?>">
	                         	<span class="label label-warning"><i class="fa fa-edit"> Edit </i></span></a>
	                        <a href="<?php echo e(URL::to('guruadmin/hapus',[$data->nip])); ?>" title="hapus"   onclick="return confirm('Apakah anda yakin akan menghapus Guru <?php echo e(($data->nip).' - '.$data->nama_guru); ?>?')">
	                            <span class="label label-danger"><i class="fa fa-trash"> Delete </i></span></a>             
	                      	<a href="<?php echo e(URL::to('guruadmin/'.$data->nama_guru.'/profile')); ?>">
