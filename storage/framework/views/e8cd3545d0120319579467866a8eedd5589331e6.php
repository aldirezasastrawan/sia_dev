		...
		<h1>
            ...
            <small>Control panel</small>
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="active">Ubah Data Pembayaran <?php echo e(Auth::user()->role->namaRule); ?></li>
		      </ol>
				    <meta charset="utf-8">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body no-padding">
                      <div class="box-body no-padding">
                      <?php echo e(Form::model($pembayarans, array('url' => array('pembayaranadmin/simpanubah', $pembayarans->id),'class' => 'form-horizontal', 'id' => 'formPembayaranUbah', ))); ?>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  <?php if($errors->has('siswas_id')): ?> has-error <?php endif; ?>">
                              <input type="text" class="form-control" name="siswas_id" value="<?php echo e($pembayarans->siswa->nama_siswa); ?>" readonly="">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  <?php if($errors->has('kelas')): ?> has-error <?php endif; ?>">
                              <input type="text" class="form-control" name="kelas" value="<?php echo e($pembayarans->siswa->kelas->nama_kelas); ?>" readonly="">
                              <small class="help-block"></small>
                              <!-- <?php if($errors->has('jurNama')): ?> <small class="help-block"><?php echo e($errors->first('jurNama')); ?></small> <?php endif; ?> -->
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3  <?php if($errors->has('tahun_ajaran')): ?> has-error <?php endif; ?>">
                            <input type="text" class="form-control" name="tahun_ajaran" value="<?php echo e($pembayarans->siswa->tahun_ajaran); ?>" readonly="">
                            <small class="help-block"></small>
                            <!-- <?php if($errors->has('jurNama')): ?> <small class="help-block"><?php echo e($errors->first('jurNama')); ?></small> <?php endif; ?> -->
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3  <?php if($errors->has('jenis_pembayaran')): ?> has-error <?php endif; ?>">
                            <input type="text" class="form-control" name="jenis_pembayaran" value="<?php echo e($pembayarans->jenis_pembayaran); ?>" readonly="">
                            <small class="help-block"></small>
                            <!-- <?php if($errors->has('jurNama')): ?> <small class="help-block"><?php echo e($errors->first('jurNama')); ?></small> <?php endif; ?> -->
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                          <label class="col-md-3 control-label">Keterangan <span class="required">* </span></label>
                            <div class="col-md-3  <?php if($errors->has('keterangan')): ?> has-error <?php endif; ?>">
                                      ...
                                      <?php echo e(Form::select('keterangan', array('' => ' ----- Pilih Keterangan Pembayaran ----- ',
                               'Lunas' => 'Lunas',
