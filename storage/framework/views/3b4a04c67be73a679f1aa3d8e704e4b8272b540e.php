		...
		<h1>
            ...
            <small><?php echo e(Auth::user()->name); ?></small>
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="active">Data Jadwal Mengajar <?php echo e(Auth::user()->role->namaRule); ?></li>
		      </ol>
				    <meta charset="utf-8">
    ...
    <div class="row">
            <div class="col-xs-12">
              <div class="box">
				...
				<div class=row>
		            <div class="col-md-6">
		                <a href="<?php echo e(url('/jadwalguru')); ?>" class="btn btn-success"><i class="fa fa-refresh"></i> Semua Data</a>
		                <a href="<?php echo e(URL::to('/jadwalguru/pdf')); ?>" class="btn btn-danger"><i class="fa fa-print"></i> Cetak Data</a>
		            </div>
		            <div class="col-md-2">
		            </div>
		            <!-- Form Pencarian -->
		            <div class="col-md-4">
		                <?php echo Form::open(['method'=>'GET','url'=>'carijadwalguru']); ?>
