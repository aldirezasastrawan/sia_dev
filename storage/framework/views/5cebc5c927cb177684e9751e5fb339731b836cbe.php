		...
		<h1>
            ...
            <small>Control panel</small>
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="active">Tambah Data Kelas <?php echo e(Auth::user()->role->namaRule); ?></li>
		      </ol>
				    <meta charset="utf-8">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body no-padding">
                      <div class="box-body no-padding">
                      <?php echo e(Form::open(array('url' => '/kelas/simpantambah', 'class' => 'form-horizontal', 'id' => 'formKelasTambah'))); ?>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  <?php if($errors->has('nama_kelas')): ?> has-error <?php endif; ?>">
                              <input type="text" class="form-control" name="nama_kelas" value="<?php echo e(Request::old('nama_kelas')); ?>" placeholder="Masukkan Nama Kelas" maxlength="25" required autofocus>
