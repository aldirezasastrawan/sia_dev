...
<br>
		...
		<h1>
            ...
            <small>Control panel</small>
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="active">Data Nilai Non Akademik <?php echo e(Auth::user()->role->namaRule); ?></li>
		      </ol>
				    <meta charset="utf-8">
				    ...
				    <div class="box-body">
	                  <form action="<?php echo e(URL::to('nilaiakademikadmin/importnilai')); ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
		                    <table class="table">
		                    <tbody>  
		                      <tr >
		                        <td colspan="2" >
    ...
    <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-body">
                	<h3 class="box-title">Daftar Data Nilai Non Akademik <a href="<?php echo e(URL::to('/nilainonakademikadmin/tambah')); ?>" class="btn btn-success btn-flat btn-sm" data-toggle="modal" title="Tambah"><i class="fa fa-plus"></i></a></h3>
				</div>
				<div class=row>
		            <div class="col-md-6">
		                <a href="<?php echo e(url('/nilainonakademikadmin')); ?>" class="btn btn-success"><i class="fa fa-refresh"></i> Semua Data</a>
		                <a href="<?php echo e(URL::to('/nilainonakademikadmin/pdf')); ?>" class="btn btn-danger"><i class="fa fa-print"></i> Cetak Data</a>
		            </div>
		            <div class="col-md-2">
		            </div>
		            <!-- Form Pencarian -->
		            <div class="col-md-4">
		                <?php echo Form::open(['method'=>'GET','url'=>'carinilainonakademikadmin']); ?>
                  ...
                  <table id="dataGuru" class="table table-bordered table-hover">
                    ...
                    <tbody>
                     <?php foreach($nilainonakademiks as $data): ?>
                      <tr>			
						...
						<td><?php echo e($data->nilai_tugas); ?></td>
						<td><?php echo e($data->nilai_ulangan); ?></td>
						<td><?php echo e($data->jumlah_nilai); ?></td>
						<td><a href="<?php echo e(URL::to('nilainonakademikadmin/'.$data->id.'/ubah')); ?>">
	                         	<span class="label label-warning"><i class="fa fa-edit"> Edit </i></span></a>
	                        <a href="<?php echo e(URL::to('nilainonakademikadmin/hapus',[$data->id])); ?>" title="hapus"   onclick="return confirm('Apakah anda yakin akan menghapus Data Nilai Non Akademik <?php echo e(($data->pelajaran->nama_pelajaran).' - '.$data->siswa->nama_siswa); ?>?')">
