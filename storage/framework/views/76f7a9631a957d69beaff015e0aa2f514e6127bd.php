                  ...
                  <div class="box-body no-padding">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  <?php if($errors->has('nama_pelajaran')): ?> has-error <?php endif; ?>">
                              <input type="text" class="form-control" name="nama_pelajaran" value="<?php echo e(Request::old('nama_pelajaran')); ?>" placeholder="Masukkan Nama Pelajaran" maxlength="25" required autofocus>
