		...
		<h1>
            ...
            <small>Control panel</small>
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="active">Tambah Data Guru <?php echo e(Auth::user()->role->namaRule); ?></li>
		      </ol>
				    <meta charset="utf-8">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body no-padding">
                      <div class="box-body no-padding">
                      <?php echo e(Form::open(array('url' => '/guruadmin/simpantambah', 'class' => 'form-horizontal', 'id' => 'formGuruTambah'))); ?>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  <?php if($errors->has('nip')): ?> has-error <?php endif; ?>">
                              <input type="text" class="form-control" name="nip" value="<?php echo e(Request::old('nip')); ?>" placeholder="Masukkan NIP" maxlength="25" required autofocus>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  <?php if($errors->has('nuptk')): ?> has-error <?php endif; ?>">
                              <input type="text" class="form-control" name="nuptk" value="<?php echo e(Request::old('nuptk')); ?>" placeholder="Masukkan NUPTK" maxlength="25" >
                              <small class="help-block"></small>
                              <!-- <?php if($errors->has('jurNama')): ?> <small class="help-block"><?php echo e($errors->first('jurNama')); ?></small> <?php endif; ?> -->
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  <?php if($errors->has('nama_guru')): ?> has-error <?php endif; ?>">
                              <input type="text" class="form-control" name="nama_guru" value="<?php echo e(Request::old('nama_guru')); ?>" placeholder="Masukkan Nama Guru" maxlength="50" required autofocus>
                              <small class="help-block"></small>
                              <!-- <?php if($errors->has('jurNama')): ?> <small class="help-block"><?php echo e($errors->first('jurNama')); ?></small> <?php endif; ?> -->
                          </div>
                      </div>
