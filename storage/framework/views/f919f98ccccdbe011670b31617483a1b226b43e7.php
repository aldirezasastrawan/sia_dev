    ...
    <div class="row">
            <div class="col-xs-12">
              <div class="box">
				...
				<div class=row>
		            <div class="col-md-6">
		                <a href="<?php echo e(url('/raporsiswa')); ?>" class="btn btn-success"><i class="fa fa-refresh"></i> Semua Data</a>
		            </div>
		            <div class="col-md-2">
		            </div>
		            <!-- Form Pencarian -->
                    ...
                    <tbody>
                     <?php foreach($siswas as $data): ?>
                      <tr>			
                        ...
                        <td><a href="<?php echo e(URL::to('raporsiswa/pdf')); ?>">
                              <span class="label label-danger"><i class="fa fa-envelope"> Rapor Akademik </i></span>
                              </a>
                              <br>
                              <br>
                        	<a href="<?php echo e(URL::to('raporsiswanon/pdf')); ?>">
