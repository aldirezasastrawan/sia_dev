		...
		<h1>
            ...
            <small>{{Auth::user()->siswa->nama_siswa}}</small>
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="active">Data Pembayaran {{Auth::user()->siswa->nama_siswa}}</li>
		      </ol>
				    <meta charset="utf-8">
    ...
    <div class="row">
            <div class="col-xs-12">
              <div class="box">
				...
				<div class=row>
		            <div class="col-md-6">
		                <a href="{{ url('/pembayaransiswa') }}" class="btn btn-success"><i class="fa fa-refresh"></i> Semua Data</a>
		                <a href="{{ URL::to('/pembayaransiswa/pdf') }}" class="btn btn-danger"><i class="fa fa-print"></i> Cetak Data</a>
		            </div>
		            <div class="col-md-2">
		            </div>
		            <!-- Form Pencarian -->
		            <div class="col-md-4">
		                {!! Form::open(['method'=>'GET','url'=>'caripembayaransiswa'])  !!}
