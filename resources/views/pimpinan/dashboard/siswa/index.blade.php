    ...
    <div class="row">
            <div class="col-xs-12">
              <div class="box">
				...
				<div class=row>
		            <div class="col-md-6">
		                <a href="{{ url('/datasiswa') }}" class="btn btn-success"><i class="fa fa-refresh"></i> Semua Data</a>
		                <a href="{{ URL::to('/datasiswa/pdf') }}" class="btn btn-danger"><i class="fa fa-print"></i> Cetak Data</a>
		            </div>
		            <div class="col-md-2">
		            </div>
		            <!-- Form Pencarian -->
                    ...
                    <tbody>
                     @foreach($siswas as $data)
                      <tr>			
                        ...
                        <td>
                        	<a href="{{{ URL::to('datasiswa/'.$data->nama_siswa.'/profile') }}}">
