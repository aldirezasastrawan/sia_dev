        ...
        <body>
            ...
            <table class="tg">
              ...
              <tr>
                ...
                <td class="tg-rv4w" width="20%">{{date('d M Y' ,strtotime($data->tanggal))}}</td>
                <td class="tg-rv4w" width="50%">{{$data->siswa->nama_siswa}}</td>
                <td class="tg-rv4w" width="40%">{{$data->thn_ajaran}}</td>
