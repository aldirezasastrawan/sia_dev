...
<br>
		...
		<h1>
            ...
            <small>Control panel</small>
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="active">Data Pembayaran {{Auth::user()->role->namaRule}}</li>
		      </ol>
				    <meta charset="utf-8">
    ...
    <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-body">
                	<h3 class="box-title">Daftar Data Pembayaran <a href="{{{ URL::to('/pembayaranadmin/tambah') }}}" class="btn btn-success btn-flat btn-sm" data-toggle="modal" title="Tambah"><i class="fa fa-plus"></i></a></h3>
				</div>    
				<div class=row>
		            <div class="col-md-6">
		                <a href="{{ url('/pembayaranadmin') }}" class="btn btn-success"><i class="fa fa-refresh"></i> Semua Data</a>
		                <a href="{{ URL::to('/pembayaranadmin/pdf') }}" class="btn btn-danger"><i class="fa fa-print"></i> Cetak Data</a>
		            </div>
		            <div class="col-md-2">
		            </div>
		            <!-- Form Pencarian -->
		            <div class="col-md-4">
		                {!! Form::open(['method'=>'GET','url'=>'caripembayaranadmin'])  !!}
                    ...
                    <tbody>
                     @foreach($pembayarans as $data)
                      <tr>			
						...
						<td><a href="{{{ URL::to('pembayaranadmin/'.$data->id.'/ubah') }}}">
	                         	<span class="label label-warning"><i class="fa fa-edit"> Edit </i></span></a>
	                        <a href="{{{  URL::to('pembayaranadmin/hapus',[$data->id]) }}}" title="hapus"   onclick="return confirm('Apakah anda yakin akan menghapus Data Pembayaran {{{($data->jenis_pembayaran).' - '.$data->siswa->nama_siswa.' -' }}}?')">
	                            <span class="label label-danger"><i class="fa fa-trash"> Delete </i></span></a>
	                            <a href="{{{ URL::to('pembayaranadmin/'.$data->id.'/cetakkwitansi') }}}">
                              <span class="label label-info"><i class="fa fa-eye"> Cetak Kwitansi Pembayaran </i></span>
                              </a>
	                    </td>
                      </tr>
                      @endforeach 
