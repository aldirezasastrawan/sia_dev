...
<br>
    ...
    <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-body">
                	<h3 class="box-title">Daftar Data Absensi Siswa  <a href="{{{ URL::to('/absensi/tambah') }}}" class="btn btn-success btn-flat btn-sm" data-toggle="modal" title="Tambah"><i class="fa fa-plus"></i></a></h3>
				</div>
				<div class=row>
		            <div class="col-md-6">
		                <a href="{{ url('/absensi') }}" class="btn btn-success"><i class="fa fa-refresh"></i> Semua Data</a>
		                <a href="{{ URL::to('/absensi/pdf') }}" class="btn btn-danger"><i class="fa fa-print"></i> Cetak Data</a>
		            </div>
		            <div class="col-md-2">
		            </div>
		            <!-- Form Pencarian -->
		            <div class="col-md-4">
		                {!! Form::open(['method'=>'GET','url'=>'cariabsensi'])  !!}
                    ...
                    <tbody>
                     @foreach($absensis as $data)
                      <tr>
						...
						<td><a href="{{{ URL::to('absensi/'.$data->id.'/ubah') }}}">
	                         	<span class="label label-warning"><i class="fa fa-edit"> Edit </i></span></a>
	                        <a href="{{{  URL::to('absensi/hapus',[$data->id]) }}}" title="hapus"   onclick="return confirm('Apakah anda yakin akan menghapus Data Absensi {{{($data->siswa->nama_siswa).' - '.$data->kelas }}}?')">
