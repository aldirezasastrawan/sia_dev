		...
		<h1>
            ...
            <small>Control panel</small>
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="active">Ubah Data Pelajaran {{Auth::user()->role->namaRule}}</li>
		      </ol>
				    <meta charset="utf-8">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body no-padding">
                      <div class="box-body no-padding">
                      {{ Form::model($pelajarans, array('url' => array('pelajaran/simpanubah', $pelajarans->id),'class' => 'form-horizontal', 'id' => 'formPelajaranUbah', )) }}
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  @if ($errors->has('nama_pelajaran')) has-error @endif">
                              <input type="text" class="form-control" name="nama_pelajaran" value="{{$pelajarans->nama_pelajaran}}">
                      ...
                      <div class="form-group">
                          <label class="col-md-3 control-label">Durasi Waktu <span class="required">* </span></label>
                            <div class="col-md-3  @if ($errors->has('durasi')) has-error @endif">
                                      ...
                                      {{ Form::select('durasi', array('' => ' ----- Pilih Durasi Pelajaran ----- ',
                               '45 Menit' => '45 Menit',
                               '60 Menit' => '60 Menit',
                      ...
                      <div class="form-group">
                          <label class="col-md-3 control-label">Keterangan <span class="required">* </span></label>
		                        <div class="col-md-3  @if ($errors->has('keterangan')) has-error @endif">
		                                  ...
		                                  {{ Form::select('keterangan', array('' => ' ----- Pilih Jenis Pelajaran ----- ',
