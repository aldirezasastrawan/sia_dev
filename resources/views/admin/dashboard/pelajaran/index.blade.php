...
<br>
		...
		<h1>
            ...
            <small>Control panel</small>
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="active">Data Pelajaran {{Auth::user()->role->namaRule}}</li>
		      </ol>
				    <meta charset="utf-8">
    ...
    <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-body">
                	<h3 class="box-title">Daftar Pelajaran <a href="{{{ URL::to('/pelajaran/tambah') }}}" class="btn btn-success btn-flat btn-sm" data-toggle="modal" title="Tambah"><i class="fa fa-plus"></i></a></h3>
				</div>
				<div class=row>
		            <div class="col-md-6">
		                <a href="{{ url('/pelajaran') }}" class="btn btn-success"><i class="fa fa-refresh"></i> Semua Data</a>
		            </div>
		            <div class="col-md-2">
		            </div>
		            <!-- Form Pencarian -->
		            <div class="col-md-4">
		                {!! Form::open(['method'=>'GET','url'=>'caripelajaran'])  !!}
                    ...
                    <tbody>
                     @foreach($pelajarans as $data)
                      <tr>			
						...
						<td><a href="{{{ URL::to('pelajaran/'.$data->id.'/ubah') }}}">
	                         	<span class="label label-warning"><i class="fa fa-edit"> Edit </i></span></a>
	                        <a href="{{{  URL::to('pelajaran/hapus',[$data->id]) }}}" title="hapus"   onclick="return confirm('Apakah anda yakin akan menghapus Pelajaran {{{($data->id).' - '.$data->nama_pelajaran }}}?')">
