		...
		<h1>
            ...
            <small>Control panel</small>
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="active">Ubah Data Kelas {{Auth::user()->role->namaRule}}</li>
		      </ol>
				    <meta charset="utf-8">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body no-padding">
                      <div class="box-body no-padding">
                      {{ Form::model($kelass, array('url' => array('kelas/simpanubah', $kelass->id),'class' => 'form-horizontal', 'id' => 'formKelasUbah', )) }}
                      <input type="hidden" name="_token" value="{{ csrf_token() }}">
   
                      <div class="form-group">
                          <label class="col-md-3 control-label">ID <span class="required">* </span></label>
                          <div class="col-md-3  @if ($errors->has('id')) has-error @endif">
                              <input type="text" class="form-control" name="id" value="{{$kelass->id}}" disabled="">
