		...
		<h1>
            ...
            <small>Control panel</small>
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="active">Tambah Data Kelas {{Auth::user()->role->namaRule}}</li>
		      </ol>
				    <meta charset="utf-8">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body no-padding">
                      <div class="box-body no-padding">
                      {{ Form::open(array('url' => '/kelas/simpantambah', 'class' => 'form-horizontal', 'id' => 'formKelasTambah')) }}
                      <input type="hidden" name="_token" value="{{ csrf_token() }}">
   
                      <div class="form-group">
                          <label class="col-md-3 control-label">Nama Kelas <span class="required">* </span></label>
                          <div class="col-md-3  @if ($errors->has('nama_kelas')) has-error @endif">
                              <input type="text" class="form-control" name="nama_kelas" value="{{Request::old('nama_kelas')}}" placeholder="Masukkan Nama Kelas" maxlength="25" required autofocus>
                      ...
                      <div class="form-group">
                          <div class="col-md-6 col-md-offset-4">
                              ...
                              <a href="{{{ URL::to('kelas') }}}" title="Cancel">
