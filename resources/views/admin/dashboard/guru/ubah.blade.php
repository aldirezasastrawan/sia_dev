		...
		<h1>
            ...
            <small>Control panel</small>
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="active">Ubah Data Guru {{Auth::user()->role->namaRule}}</li>
		      </ol>
				    <meta charset="utf-8">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body no-padding">
                      <div class="box-body no-padding">
                      {{ Form::model($gurus, array('url' => array('guruadmin/simpanubah', $gurus->id),'class' => 'form-horizontal', 'id' => 'formGuruUbah', )) }}
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  @if ($errors->has('nama_guru')) has-error @endif">
                              <input type="text" class="form-control" name="nama_guru" value="{{$gurus->nama_guru}}">
                              <small class="help-block"></small>
                              <!-- @if ($errors->has('jurNama')) <small class="help-block">{{ $errors->first('jurNama') }}</small> @endif -->
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          <label class="col-md-3 control-label">Keterangan <span class="required">* </span></label>
		                        <div class="col-md-3  @if ($errors->has('keterangan')) has-error @endif">
		                                  ...
		                                  {{ Form::select('keterangan', array('' => ' ----- Pilih Keterangan----- ',
