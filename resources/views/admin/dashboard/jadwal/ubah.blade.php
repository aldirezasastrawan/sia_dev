		...
		<h1>
            ...
            <small>Control panel</small>
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="active">Ubah Data Jadwal Pelajaran {{Auth::user()->role->namaRule}}</li>
		      </ol>
				    <meta charset="utf-8">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body no-padding">
                      <div class="box-body no-padding">
                      {{ Form::model($jadwals, array('url' => array('jadwaladmin/simpanubah', $jadwals->id),'class' => 'form-horizontal', 'id' => 'formJadwalUbah', )) }}
                        ...
                        <div class="form-group">
                          <label class="col-md-3 control-label">Hari <span class="required">* </span></label>
                            <div class="col-md-3  @if ($errors->has('hari')) has-error @endif">
                                      ...
                                      {{ Form::select('hari', array('' => ' ----- Pilih Hari ----- ',
                               'Senin' => 'Senin',
                               'Selasa' => 'Selasa',
                               'Rabu' => 'Rabu',
                               'Kamis' => 'Kamis',
                               ...
                               'Sabtu' => 'Sabtu',
                                  ...
                                  <!-- <input type="text" class="form-control" name="hari" value="{{Request::old('hari')}}"> -->
                                  <small class="help-block"></small>
                                  <!-- @if ($errors->has('jurNama')) <small class="help-block">{{ $errors->first('jurNama') }}</small> @endif -->
                            </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          <label class="col-md-3 control-label">Siswa <span class="required">* </span></label>
                            <div class="col-md-3  @if ($errors->has('siswa')) has-error @endif">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-3  @if ($errors->has('gedung')) has-error @endif">
                              <input type="text" class="form-control" name="gedung" value="{{$jadwals->gedung}}">
                              <small class="help-block"></small>
                              <!-- @if ($errors->has('jurNama')) <small class="help-block">{{ $errors->first('jurNama') }}</small> @endif -->
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  @if ($errors->has('ruangan')) has-error @endif">
                              <input type="text" class="form-control" name="ruangan" value="{{$jadwals->ruangan}}">
                              <small class="help-block"></small>
                              <!-- @if ($errors->has('jurNama')) <small class="help-block">{{ $errors->first('jurNama') }}</small> @endif -->
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          <label class="col-md-3 control-label">Status Mata Pelajaran <span class="required">* </span></label>
                            <div class="col-md-3  @if ($errors->has('status_mapel')) has-error @endif">
                                      ...
                                      {{ Form::select('status_mapel', array('' => ' ----- Pilih Status Mapel ----- ',
                               'Hadir' => 'Hadir',
                               'Izin' => 'Izin',
                               'Tidak Ada Keterangan' => 'Tidak Ada Keterangan',
                               ), $jadwals->status_mapel, array('class' => 'form-control')) }}
                               
                                  <!-- <input type="text" class="form-control" name="status_mapel" value="{{Request::old('status_mapel')}}"> -->
                                  <small class="help-block"></small>
                                  <!-- @if ($errors->has('jurNama')) <small class="help-block">{{ $errors->first('jurNama') }}</small> @endif -->
                            </div>
                      </div>
