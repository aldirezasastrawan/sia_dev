            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body no-padding">
                      <div class="box-body no-padding">
                      {{ Form::open(array('url' => '/register/simpantambah', 'class' => 'form-horizontal')) }}
                      <input type="hidden" name="_token" value="{{ csrf_token() }}">         
                              <div class="form-group">
                                  ...
                                  <div class="col-md-3  @if ($errors->has('username')) has-error @endif">
                                      <input type="text" class="form-control" name="username" value="{{Request::old('username')}}" placeholder="Masukkan Username" maxlength="25" required autofocus>
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-md-3  @if ($errors->has('name')) has-error @endif">
                                      <input type="text" class="form-control" name="name" value="{{Request::old('name')}}" placeholder="Masukkan Nama" maxlength="25" required autofocus>
                                      <small class="help-block"></small>
                                      <!-- @if ($errors->has('jurNama')) <small class="help-block">{{ $errors->first('jurNama') }}</small> @endif -->
                                  </div>
                              </div>   
                              ...
                              <div class="form-group">
                                  <label class="control-label col-md-4">Nama Guru </label>
                                    <div class="col-md-3">
                                      {{ Form::select('gurus_id', $gurus, null, array('class' => 'form-control input-large select2me')) }}
                                    </div>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                  <label class="control-label col-md-4">Role Level </label>
                                    <div class="col-md-3">
                                      {{ Form::select('roles_id', $roles, null, array('class' => 'form-control input-large select2me')) }}
                                    </div>
                              </div>
