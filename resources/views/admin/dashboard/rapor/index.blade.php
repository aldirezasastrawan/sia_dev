		...
		<h1>
            ...
            <small>Control panel</small>
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="active">Data Rapor Siswa {{Auth::user()->role->namaRule}}</li>
		      </ol>
				    <meta charset="utf-8">
    ...
    <div class="row">
            <div class="col-xs-12">
              <div class="box">
				...
				<div class=row>
		            <div class="col-md-6">
		                <a href="{{ url('/raporadmin') }}" class="btn btn-success"><i class="fa fa-refresh"></i> Semua Data</a>
		            </div>
		            <div class="col-md-2">
		            </div>
		            <!-- Form Pencarian -->
		            <div class="col-md-4">
		                {!! Form::open(['method'=>'GET','url'=>'cariraporsiswa'])  !!}
                    ...
                    <tbody>
                     @foreach($siswas as $data)
                      <tr>			
                        ...
                        <td><a href="{{{ URL::to('raporadmin/'.$data->nama_siswa.'/detail') }}}">
                              <span class="label label-danger"><i class="fa fa-envelope"> Rapor Akademik </i></span>
                              </a>
                              <br>
                              <br>
                        	<a href="{{{ URL::to('raporadmin/'.$data->nama_siswa.'/rapor') }}}">
