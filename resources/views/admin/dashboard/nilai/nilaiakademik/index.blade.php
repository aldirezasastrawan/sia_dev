...
<br>
		...
		<h1>
            ...
            <small>Control panel</small>
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="active">Data Nilai Akademik {{Auth::user()->role->namaRule}}</li>
		      </ol>
				    <meta charset="utf-8">
    ...
    <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-body">
                	<h3 class="box-title">Daftar Data Nilai Akademik <a href="{{{ URL::to('/nilaiakademikadmin/tambah') }}}" class="btn btn-success btn-flat btn-sm" data-toggle="modal" title="Tambah"><i class="fa fa-plus"></i></a></h3>
				</div>
				<div class=row>
		            <div class="col-md-6">
		                <a href="{{ url('/nilaiakademikadmin') }}" class="btn btn-success"><i class="fa fa-refresh"></i> Semua Data</a>
		                <a href="{{ URL::to('/nilaiakademikadmin/pdf') }}" class="btn btn-danger"><i class="fa fa-print"></i> Cetak Data</a>
		            </div>
		            <div class="col-md-2">
		            </div>
		            <!-- Form Pencarian -->
		            <div class="col-md-4">
		                {!! Form::open(['method'=>'GET','url'=>'carinilaiakademikadmin'])  !!}
