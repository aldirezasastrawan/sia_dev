		...
		<h1>
            ...
            <small>Control panel</small>
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="active">Ubah Data Nilai Akademik {{Auth::user()->role->namaRule}}</li>
		      </ol>
				    <meta charset="utf-8">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body no-padding">
                      <div class="box-body no-padding">
                      {{ Form::model($nilaiakademiks, array('url' => array('nilaiakademikadmin/simpanubah', $nilaiakademiks->id),'class' => 'form-horizontal', 'id' => 'formNilaiakademikUbah', )) }}
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  @if ($errors->has('nama_siswa')) has-error @endif">
                              <input type="text" class="form-control" name="nama_siswa" value="{{$nilaiakademiks->siswa->nama_siswa}}" disabled="">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-3  @if ($errors->has('nilai_tugas')) has-error @endif">
                              <input type="text" class="form-control" name="nilai_tugas" value="{{$nilaiakademiks->nilai_tugas}}">
                              <small class="help-block"></small>
                              <!-- @if ($errors->has('jurNama')) <small class="help-block">{{ $errors->first('jurNama') }}</small> @endif -->
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-3  @if ($errors->has('nilai_ulangan')) has-error @endif">
                              <input type="text" class="form-control" name="nilai_ulangan" value="{{$nilaiakademiks->nilai_ulangan}}">
                              <small class="help-block"></small>
                              <!-- @if ($errors->has('jurNama')) <small class="help-block">{{ $errors->first('jurNama') }}</small> @endif -->
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          <div class="col-md-6 col-md-offset-4">
                              ...
                              <a href="{{{ URL::to('nilaiakademikadmin') }}}" title="Cancel">
