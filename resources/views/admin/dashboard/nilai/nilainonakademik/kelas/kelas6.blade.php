		...
		<h1>
            ...
            <small>Control panel</small>
		      ...
		      <ol class="breadcrumb">
		        ...
		        <li class="active">Data Nilai Non Akademik Siswa {{Auth::user()->role->namaRule}}</li>
		      </ol>
				    <meta charset="utf-8">
	                	...
	                	<div class="box-body">
	                		<h3 class="box-title">Nilai Non Akademik </h3>
		                        ...
		                        <div id="panel_tab2_example1" class="tab-pane active">
		                            <form action="{{URL:: to('/nilainonakademik/tambah/simpannilainonakademikkelas')}}" method="post">
